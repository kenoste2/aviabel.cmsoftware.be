...
class Application_Form_DebtorContact extends Zend_Form {
    ...
    public function init($debtorId = false) {
        ...
        $this->addElement('select', 'LANGUAGE_CODE_ID', array('label' => $functions->T('language_c'), 'MultiOptions' => $functions->db2array($languageModel->getLanguages()), 'required' => false));
