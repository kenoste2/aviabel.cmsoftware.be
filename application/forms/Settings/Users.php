...
class Application_Form_Settings_Users extends Zend_Form {
    ...
    public function init() {
        ...
        $this->addElement('select', 'RIGHTS', array('label' => $functions->T('Right_level_c'), 'required' => true, 'MultiOptions' => array(3 => $functions->T('user_c'), 4 => $functions->T('Admin_user_c'), 5 => $functions->T('Client_user_c'), 6 =>$functions->T('collector_c'))));
