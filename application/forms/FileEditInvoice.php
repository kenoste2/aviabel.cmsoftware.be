...
class Application_Form_FileEditInvoice extends Zend_Form {
    ...
    public function init() {
        ...
        $this->addElement('text', 'INTEREST_PERCENT',array('label' => $functions->T('Interest_percent_c'),'size' => 5, 'validators'=> array('float')));
        $this->addElement('text', 'COST_PERCENT',array('label' => $functions->T('Cost_percent_c'),'size' => 5, 'validators'=> array('float')));
        $this->addElement('text', 'INTEREST_MINIMUM',array('label' => $functions->T('Interest_minimum_c'),'size' => 5, 'validators'=> array('float')));
        $this->addElement('text', 'COST_MINIMUM',array('label' => $functions->T('Cost_minimum_c'),'size' => 5, 'validators'=> array('float')));
