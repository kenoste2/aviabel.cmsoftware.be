...
class Application_Form_ClientInvoiceParams extends Zend_Form {
    ...
    public function init() {
        ...
        $this->addElement('text', 'END_VALUE', array('label' => $functions->T('end_value_c'), 'required' => true, 'validators' => array($helper->getFloatValidator()), 'size' => 15));
        $this->addElement('text', 'INVOICE_PERCENT', array('label' => $functions->T('percent_c'), 'required' => true, 'validators' => array($helper->getFloatValidator()), 'size' => 15));
        $this->addElement('text', 'INVOICE_MINIMUM', array('label' => $functions->T('min_cost_c'), 'required' => true, 'validators' => array($helper->getFloatValidator()), 'size' => 15));
